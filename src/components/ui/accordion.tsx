...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-5 text-left text-base font-medium text-dark-neutral transition-all hover:text-dark-blue [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
