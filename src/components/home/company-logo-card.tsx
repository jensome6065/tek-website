...
export function CompanyLogoCard({
  ...
  if (decorative) {
    // Reuse cached optimized URLs without a second interactive tree.
    return (
      <li className="group relative shrink-0 list-none" aria-hidden>
        <span className="relative flex h-14 w-32 items-center justify-center rounded-xl bg-white px-3 shadow-soft">
          {logo}
        </span>
      </li>
    );
  ...
  return (
    <li className="group relative shrink-0 list-none">
      <a
        ...
        className="relative flex h-14 w-32 items-center justify-center rounded-xl bg-white px-3 shadow-soft transition-shadow duration-300 group-hover:shadow-elevated focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-medium-blue focus-visible:ring-offset-2"
      >
